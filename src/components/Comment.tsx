    ...
    <div className="flex gap-2 sm:gap-3">
      ...
      <div className="flex-1">
        <div className="flex items-center gap-2">
          <span className="text-white font-semibold text-sm sm:text-base">{author.name}</span>
          <span className="text-gray-400 text-xs">{timestamp}</span>
        </div>
        <div className="text-white text-sm sm:text-base mt-1">{content}</div>
        <div className="flex items-center gap-3 sm:gap-4 mt-2 text-gray-400 text-xs sm:text-sm">
